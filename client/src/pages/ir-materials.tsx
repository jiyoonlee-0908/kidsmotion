        ...
        <div className="mb-20">
          ...
          <div className="grid lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-8 shadow-lg">
              ...
              <div className="space-y-4 text-gray-700">
                <div>
                  ...
                  <p className="text-sm">사업 총괄, 시장 개척, 투자 유치</p>
                </div>
                <div>
                  <h4 className="font-bold text-gray-800 mb-2">💼 경력</h4>
                  <ul className="text-sm space-y-1">
                    <li>• 10년+ 아카데미 운영 경험</li>
                    <li>• 아동 체육 전문가</li>
                    <li>• 시장 개발 및 고객 관리</li>
                  </ul>
                </div>
                <div>
                  ...
                  <p className="text-sm">현장 경험 기반 시장 통찰력, 고객 니즈 파악</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-3xl p-8 shadow-lg">
              ...
              <div className="space-y-4 text-gray-700">
                <div>
                  <h4 className="font-bold text-gray-800 mb-2">⚡ 핵심 역할</h4>
                  <p className="text-sm">기술 개발, 시스템 구축, AI 알고리즘</p>
                </div>
                <div>
                  <h4 className="font-bold text-gray-800 mb-2">🏆 경력</h4>
                  <ul className="text-sm space-y-1">
                ...
                <div>
                  <h4 className="font-bold text-gray-800 mb-2">🎯 강점</h4>
                  <p className="text-sm">운동생리학 전문 지식, 데이터 분석 역량</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-3xl p-8 shadow-lg">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-purple-800">하드웨어 개발</h3>
                <p className="text-lg text-purple-600 font-medium">파트너사</p>
              </div>
              <div className="space-y-4 text-gray-700">
                <div>
                  <h4 className="font-bold text-gray-800 mb-2">🔧 핵심 역할</h4>
                  <p className="text-sm">MotionBike 제조, 센서 통합</p>
                </div>
                <div>
                  <h4 className="font-bold text-gray-800 mb-2">🏭 역량</h4>
                  <ul className="text-sm space-y-1">
                    <li>• 스마트 사이클 전문 제조</li>
                    <li>• 정밀 센서 기술</li>
                    <li>• 대량 생산 시스템</li>
                ...
                <div>
                  <h4 className="font-bold text-gray-800 mb-2">🚀 강점</h4>
                  <p className="text-sm">안정적 하드웨어 공급, 기술 지원</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 text-center">
            <div className="bg-gradient-to-r from-amber-100 to-orange-100 rounded-2xl p-8 max-w-4xl mx-auto">
              <h3 className="text-2xl font-bold text-amber-800 mb-4">💡 팀의 시너지</h3>
              <p className="text-lg text-gray-700 leading-relaxed">
                <span className="font-bold text-blue-600">현장 경험</span> + 
                <span className="font-bold text-green-600"> 기술 전문성</span> + 
                <span className="font-bold text-purple-600"> 하드웨어 역량</span> = 
                <span className="font-bold text-amber-600"> 완벽한 솔루션</span>
              </p>
            </div>
          </div>
        </div>
