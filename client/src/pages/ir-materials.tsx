          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-3xl p-10 shadow-lg border border-gray-100">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">대표자 카드</h3>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p className="leading-relaxed">현장 피드백 기반 B2B 제품 설계 및 병원·보건소·체육시설 네트워크 확보</p>
            ...
            <div className="bg-white rounded-3xl p-10 shadow-lg border border-gray-100">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">팀원 카드</h3>
            ...
            <div className="bg-white rounded-3xl p-10 shadow-lg border border-gray-100">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">파트너 카드</h3>
