      ...
      <div className="max-w-7xl mx-auto px-6 py-12 pt-24">
        ...
        <div className="mb-32">
          <div className="text-center mb-20">
            <h1 className="text-5xl font-bold text-purple-800 mb-6">💝 창업자 편지</h1>
            <p className="text-3xl text-purple-600 font-medium">"체력측정의 패러다임을 바꾸다"</p>
          </div>
          
          {/* 문제 인식 섹션 */}
          <div className="mb-24 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl p-16">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-blue-800 mb-4">현재 체력측정의 한계</h2>
                <div className="w-24 h-1 bg-blue-600 mx-auto rounded-full"></div>
              </div>
              
              <div className="space-y-8 text-xl leading-relaxed text-gray-700">
                <div className="bg-white p-8 rounded-2xl shadow-md">
                  <p className="text-center"><span className="font-bold text-blue-700 text-2xl">통계청 발표에 따르면, 국민의 80%가 과학적 체력관리가 필요하다고 합니다.</span></p>
                </div>
                
                <p className="text-center">하지만 현실은 어떨까요?</p>
                
                <div className="bg-white p-8 rounded-2xl shadow-md border-l-4 border-red-500">
                  <p>체내 측정은 <span className="font-bold text-green-600">인바디</span>로, 관절가동범위는 <span className="font-bold text-green-600">모션캡처</span>로 디지털화되었지만,</p>
                  <p className="mt-4">정작 체력의 핵심인 <span className="font-bold text-red-600 text-2xl">순발력, 근력, 지구력 측정은 여전히 아날로그</span>입니다.</p>
                </div>
                
                <div className="bg-white p-8 rounded-2xl shadow-md border-l-4 border-red-500">
                  <p>PAPS 장비가 디지털화되었다고 하지만, 여전히 '몇 분 몇 초', '몇 미터'로만 측정됩니다.</p>
                  <p className="mt-4 font-bold text-red-600 text-xl">힘의 단위인 W(와트)로 측정되지 않아 정확히 언제, 어떻게 힘을 썼는지 알 수 없습니다.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* 혁신 솔루션 섹션 */}
          <div className="mb-24 bg-gradient-to-r from-purple-50 to-pink-50 rounded-3xl p-16">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-purple-800 mb-4">KidsMotion의 혁신적 해결책</h2>
                <div className="w-24 h-1 bg-purple-600 mx-auto rounded-full"></div>
              </div>

              <div className="bg-white p-10 rounded-3xl shadow-xl border-2 border-purple-200">
                <h3 className="text-2xl font-bold text-center text-purple-800 mb-8">기존 3가지 vs 우리의 6단계 과학적 평가</h3>
                
                <div className="grid grid-cols-2 gap-12">
                  <div className="bg-red-50 p-8 rounded-2xl border-2 border-red-200">
                    <h4 className="text-xl font-bold text-red-700 mb-6 text-center">기존 방식의 한계</h4>
                    <div className="space-y-4">
                      <div className="bg-white p-4 rounded-xl shadow-sm">
                        <p className="text-red-600 font-medium">• 멀리뛰기 → 거리만 측정</p>
                      </div>
                      <div className="bg-white p-4 rounded-xl shadow-sm">
                        <p className="text-red-600 font-medium">• 근거리 달리기 → 시간만 측정</p>
                      </div>
                      <div className="bg-white p-4 rounded-xl shadow-sm">
                        <p className="text-red-600 font-medium">• 장거리 달리기 → 지속시간만 측정</p>
                      </div>
                    </div>
                  </div>
                  
                  <div className="bg-blue-50 p-8 rounded-2xl border-2 border-blue-200">
                    <h4 className="text-xl font-bold text-blue-700 mb-6 text-center">KidsMotion 6단계 과학적 평가</h4>
                    <div className="space-y-3">
                      <div className="bg-white p-4 rounded-xl shadow-sm">
                        <p className="text-blue-600 font-medium"><span className="font-bold text-blue-800">5초</span> → 순발력 W 단위 정밀측정</p>
                      </div>
                      <div className="bg-white p-4 rounded-xl shadow-sm">
                        <p className="text-blue-600 font-medium"><span className="font-bold text-blue-800">15초</span> → 근력 생체역학적 분석</p>
                      </div>
                      <div className="bg-white p-4 rounded-xl shadow-sm">
                        <p className="text-blue-600 font-medium"><span className="font-bold text-blue-800">30초</span> → 젖산 역치 정확한 파악</p>
                      </div>
                      <div className="bg-white p-4 rounded-xl shadow-sm">
                        <p className="text-blue-600 font-medium"><span className="font-bold text-blue-800">60초</span> → 근지구력 세밀한 평가</p>
                      </div>
                      <div className="bg-white p-4 rounded-xl shadow-sm">
                        <p className="text-blue-600 font-medium"><span className="font-bold text-blue-800">180초</span> → 유산소/무산소 경계 측정</p>
                      </div>
                      <div className="bg-white p-4 rounded-xl shadow-sm">
                        <p className="text-blue-600 font-medium"><span className="font-bold text-blue-800">360초</span> → 심폐지구력 종합 분석</p>
                      </div>
                      <div className="bg-white p-4 rounded-xl shadow-sm">
                        <p className="text-blue-600 font-medium"><span className="font-bold text-blue-800">밸런스</span> → 성장기 불균형 조기 발견</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="mb-24">
            <div className="max-w-5xl mx-auto">
              <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-12 rounded-3xl shadow-2xl text-center">
                <p className="text-2xl font-bold mb-6">"달리기와 멀리뛰기는 체력을 측정하는 도구가 아닙니다."</p>
                <p className="text-xl">체력을 증진시키는 훈련방법이어야 합니다.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-24">
            <div className="max-w-6xl mx-auto grid grid-cols-2 gap-12">
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-10 rounded-3xl shadow-xl">
                <div className="bg-gray-800 text-white p-6 rounded-2xl mb-6">
                  <h4 className="text-xl font-bold text-center">왜 사이클인가?</h4>
                </div>
                <p className="text-lg leading-relaxed text-gray-700">사이클링은 다리만의 운동이 아닙니다.</p>
                <p className="text-lg leading-relaxed text-gray-700 mt-4"><span className="font-bold text-blue-600">진정한 파워를 내기 위해서는 전신의 힘을 통합적으로 사용</span>해야 합니다.</p>
                <p className="text-lg leading-relaxed text-gray-700 mt-4">대칭 기구의 특성상 <span className="font-bold text-blue-600">좌우 불균형을 0.01% 단위까지 정확하게 감지</span>할 수 있습니다.</p>
              </div>

              <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-10 rounded-3xl shadow-xl">
                <div className="bg-blue-600 text-white p-6 rounded-2xl mb-6">
                  <h4 className="text-xl font-bold text-center">데이터 기반 맞춤형 성장</h4>
                </div>
                <div className="space-y-4">
                  <div className="bg-white p-4 rounded-xl shadow-sm">
                    <p className="text-blue-700 font-medium"><span className="font-bold">정밀 측정</span>: W(와트) 단위 파워 측정</p>
                  </div>
                  <div className="bg-white p-4 rounded-xl shadow-sm">
                    <p className="text-blue-700 font-medium"><span className="font-bold">AI 분석</span>: 개별 아동의 성장 패턴 예측</p>
                  </div>
                  <div className="bg-white p-4 rounded-xl shadow-sm">
                    <p className="text-blue-700 font-medium"><span className="font-bold">추적 관리</span>: 과학적 순환 체계 구축</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* 마무리 메시지 */}
          <div className="max-w-5xl mx-auto">
            <div className="bg-white p-12 rounded-3xl shadow-2xl border-4 border-purple-200">
              <p className="text-2xl font-bold text-purple-800 text-center leading-relaxed">
                "측정이 올바라야 평가가 정확하고,<br/>
                평가가 정확해야 훈련이 효과적입니다."
              </p>
              <div className="w-32 h-1 bg-purple-600 mx-auto my-8 rounded-full"></div>
              <p className="text-xl text-gray-700 text-center leading-relaxed">
                KidsMotion으로 아이들의 체력을 과학적으로 측정하고,<br/>
                데이터 기반 개인 맞춤형 성장을 지원하겠습니다.
              </p>
              <p className="text-right text-xl font-medium text-purple-600 mt-8">– 모션바이크 대표</p>
            </div>
          </div>
        </div>
