...
AI는 다음 4개 부분을 작성해주세요. JSON 형식으로 응답하세요:
{
  ...
  "comprehensiveAnalysis": "체력 종합분석 간단 요약. 2-3줄로 ${data.studentName}님의 전체적인 체력 상태를 요약 (이름 뒤에 반드시 '님' 붙이기)",
  "overallAssessment": "# 1. ${data.studentName}님의 오늘 한눈에 보기\n${data.studentName}님은 또래보다 뛰어난 [최고항목]을 가지고 있으며, 이는 다양한 운동에서 장점이 됩니다. 하지만 [약점항목]이 부족하여 장기적인 운동 능력 향상에 방해가 될 수 있습니다.\n\n# 2. 강점 & 잠재력\n${data.studentName}님은 [최고항목]에서 상위 [백분위]%를 차지하고 있으며, 이는 또래 아이들 중 상위 [등수]명 안에 든다는 것입니다...\n\n# 3. 우선 개선 영역\n${data.studentName}님의 [약점항목]은 하위 [백분위]%로, 또래 100명 중 [등수]등에 해당하는 수준입니다...\n\n# 4. 이번 주 해야 할 일\n매일 10분간의 간단한 운동으로...\n\n# 5. 이번 달 목표\n이번 달의 목표는...\n\n# 6. 3개월 로드맵\n1개월차에는...\n\n# 7. 부모 참여 운동법\n가족과 함께 할 수 있는 운동으로는...\n\n# 8. 안전 주의사항\n운동 중 즉시 중단해야 하는 신호로는...\n\n# 9. 다음 측정 예상 개선치\n3개월 후, ${data.studentName}님의 [약점항목]은...% 개선을 기대할 수 있습니다.\n\n각 단계마다 구체적인 수치와 **강조**를 포함하여 상세하게 작성하세요."
}
