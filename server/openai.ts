...
AI는 다음 4개 부분을 작성해주세요. JSON 형식으로 응답하세요:
{
  ...
  "comprehensiveAnalysis": "체력 종합분석 AI 요약. 줄바꿈(\\n)과 강조(**굵게**)를 적절히 사용하여 읽기 쉽게 작성. ${data.studentName}님의 이름을 자연스럽게 활용하여 개인 맞춤형 분석 제공 (이름 뒤에 반드시 '님' 붙이기)",
  "overallAssessment": "상세분석리포트를 정확히 9단계로 작성하세요. 반드시 다음 형식을 따르세요:\n\n# 1. ${data.studentName}님의 오늘 한눈에 보기\n${data.studentName}님은 또래보다 뛰어난 [강점]을 가지고 있으며, 이는 다양한 운동에서 장점이 됩니다. 하지만 [약점]이 부족하여 장기적인 운동 능력 향상에 방해가 될 수 있습니다.\n\n# 2. 강점 & 잠재력\n${data.studentName}님은 [가장 높은 항목]에서 상위 [백분위]%를 차지하고 있으며...\n\n이런 식으로 9단계까지 모두 작성하고, **강조**, 구체적 수치, 실용적 조언을 포함하세요."
}
