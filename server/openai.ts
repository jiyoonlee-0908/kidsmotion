...
{
  "summary": "15년 경력의 아동 운동생리학 박사 관점에서 부모가 이해하기 쉽게 강점과 보완점을 상세하게 5-8줄로 작성. ${data.studentName}의 개별적 특성과 BMI, 체중, 키 정보를 활용하여 구체적이고 전문적인 분석 제공. 단순 요약이 아닌 교육적 가치가 있는 상세한 설명으로 작성",
